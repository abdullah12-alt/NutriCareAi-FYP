...
def accept_appointment(request, pk):
    ...
    # try:
    #     send_mail(subject, plain_message, 'abdullahhassancode@gmail.com',  [patient_email], html_message=html_message, fail_silently=False)
...
def doctor_profile(request, pk):
    ...
    # doctor_review = Doctor_review.objects.filter()
    
    print("doctor_review" ,doctor_review)
...
def my_patients(request):
    if request.user.is_doctor:
        ...
        appointments = Appointment.objects.filter(doctor=doctor).filter()
